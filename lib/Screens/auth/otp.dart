...
class _OTPState extends State<OTP> {
                ...
                child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(
                          phoneNumberChangedSuccessfullyText,
  ...
  _verificationFailed(AuthException authException, BuildContext context) {
    CustomSnackbar.snackbar(
        "$exceptionMessageText" + authException.message.toString(),
        _scaffoldKey);
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ListTile(
                title: Text(
                  verifyYourNumberText,
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 27, fontWeight: FontWeight.bold),
                ),
                subtitle: Text(
                  pleaseEnterYouMobileNumberText,
                  textAlign: TextAlign.center,
