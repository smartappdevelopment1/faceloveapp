...
import 'package:hookup4u/Screens/Calling/call.dart';
                      ...
                      case "Awaiting":
                        {
                          return Column(
                            ...
                            children: <Widget>[
                              ...
                              Text("$callingToText ${widget.receiver.name}...",
                                  style: TextStyle(
                                      fontSize: 25,
                      ...
                      case "Decline":
                        {
                          return Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              Text("${widget.receiver.name} $isBusyText",
                                  style: TextStyle(
                                      fontSize: 25,
                                      fontWeight: FontWeight.bold)),
                              RaisedButton.icon(
                      ...
                      case "Not-answer":
                        {
                          return Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              Text("${widget.receiver.name} $isNotAnsweringText",
                                  style: TextStyle(
                                      fontSize: 25,
                                      fontWeight: FontWeight.bold)),
                              RaisedButton.icon(
