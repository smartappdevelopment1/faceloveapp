    ...
    if (widget.isPaymentSuccess != null && !widget.isPaymentSuccess) {
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        await Alert(
          ...
          title: "$failedText",
          desc: "$oopsSomethingWentWrongTryAgainText",
          buttons: [
            DialogButton(
              child: Text(
                "$retryText",
        ...
        (error) {
          _scaffoldKey.currentState.showSnackBar(
            SnackBar(
              content: error != null
                  ? Text('$error')
                  : Text("$oopsSomethingWentWrongTryAgainText"),
            ),
          );
        },
      );
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text(
                      "${searchUserAroundText.replaceAll("_", widget.items['paid_radius'] ?? "")}"
                          ,
                      style: TextStyle(
                  ...
                  _isLoading
                      ...
                      : products.length > 0
                          ...
                          : Container(
                              height: MediaQuery.of(context).size.width * .8,
                              child: Center(
                                child: Text("$noActiveProductFoundText"),
                              ),
                            )
                ],
              ),
                ...
                onTap: () async {
                  if (selectedProduct != null)
                    ...
                    CustomSnackbar.snackbar(
                        "$youMustChooseASubscriptionToContinueText",
                        _scaffoldKey);
                  }
                },
              )),
