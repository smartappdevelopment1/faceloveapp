    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return CupertinoAlertDialog(
              title: Text(
                  isProfilePicture ? "$updateProfilePictureText" : "$addProfilePictureText"),
              content: Text(
                "$selectSourceText",
              ),
                  ...
                  Padding(
                    ...
                    child: ListBody(
                      ...
                      children: <Widget>[
                        ListTile(
                          title: Text(
                            "$aboutText ${widget.currentUser.name}",
                            style: TextStyle(
                          ...
                          child: ListTile(
                            ...
                            subtitle: DropdownButton(
                              ...
                              items: [
                                ...
                                DropdownMenuItem(
                                    child: Text("$otherText"), value: "other"),
                              ],
                              onChanged: (val) {
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text("$makeMyDistanceVisibleText"),
                                      ),
                                      Switch(
                                          activeColor: primaryColor,
