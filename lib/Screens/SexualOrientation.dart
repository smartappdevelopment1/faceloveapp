...
class _SexualOrientationState extends State<SexualOrientation> {
  List<Map<String, dynamic>> orientationlist = [
    {'name': 'Christian', 'ontap': false},
    {'name': 'Catholic', 'ontap': false},
    {'name': 'Muslim', 'ontap': false},
    {'name': 'other', 'ontap': false},
    {'name': 'prefer not to say', 'ontap': false}
  ];
  List selected = [];
  bool select = false;
                      ...
                      : Padding(
                          ...
                          child: Align(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                CustomSnackbar.snackbar(
                                    "$pleaseSelectOneText", _scaffoldKey);
                              },
                            ),
                          ),
                        )
